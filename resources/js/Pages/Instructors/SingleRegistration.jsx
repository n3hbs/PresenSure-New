...
export default function SingleRegistration() {
    ...
    const handleChange = (event) => {
        ...
        if (name === "user_id") {
            setForm((current) => ({
                ...current,
                user_id: makeInstructorId(value),
            }));
            return;
        }
    ...
    const submitRegistration = async () => {
        ...
        try {
            const response = await api.post("/instructor", payload, {
                headers: {
                    ...getAuthHeaders(),
            ...
            showToast(
                ...
                response.data?.message || "Instructor registered successfully.",
            );
            resetRegistration();
    ...
    const discardAndLeave = () => {
        const targetUrl = pendingNavigationUrl || "/instructors";
    ...
    return (
        <>
            <Head title="Single Registration - Instructor" />
            ...
            <div className="space-y-6">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    ...
                    <button
                        type="button"
                        onClick={() => requestPage("/instructors")}
                ...
                <InstructorRegistrationStepper currentStep={currentStep} />
                ...
                {currentStep === 1 && (
                    <SingleInstructorRegistrationForm
                        ...
                        onCancel={() => requestPage("/instructors")}
                    />
                )}
