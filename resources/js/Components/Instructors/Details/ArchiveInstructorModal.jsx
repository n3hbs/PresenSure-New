...
export default function ArchiveInstructorModal({
    isOpen,
    onClose,
    user = {},
    onSuccess,
    ...
    const handleArchive = async () => {
        ...
        try {
            ...
            await api.delete(`instructor/${user.user_id}`, {
                headers: token ? { Authorization: `Bearer ${token}` } : {},
            });

            notify.success(
                "Instructor Archived",
                "Instructor has been archived successfully."
            );
            ...
            const message =
                ...
                "Failed to archive instructor. Please try again.";
