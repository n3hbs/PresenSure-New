...
const formatInstructorName = (user = {}) => {
...
export default function InstructorDetailsContent({
    user = {},
    instructor = {},
    role = {},
    profile = {},
    ...
    const profileImage = profile.imagelink || profile.image_link || NoImage;
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex flex-col gap-6 md:flex-row md:items-center">
                    ...
                    <div className="min-w-0 flex-1 space-y-4">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-2 md:justify-start">
                            ...
                            <span className="inline-flex items-center rounded-full bg-blue-50 text-blue-700 border border-blue-200/70 px-3 py-1 text-xs font-semibold">
                                Instructor
                            </span>
                        </div>

                        {/* Row 1: Instructor ID | Name */}
            ...
            {/* Enrolled/Assigned Teaching Courses Section */}
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400">
                                Teaching course blocks and schedules for the active semester
                            </p>
                        </div>
                    </div>
                    {courses.length > 0 && (
                ...
                {courses.length > 0 ? (
                    ...
                    <div className="mt-5 rounded-xl border border-dashed border-gray-200 bg-gray-50/70 px-4 py-10 text-center">
                        ...
                        <p className="mt-1 text-xs text-gray-400">
                            This instructor has not been assigned to any course blocks for the active semester yet.
                        </p>
                    </div>
                )}
            </section>
